         ...
         <tbody>
            ...
            <tr>
               ...
               <td>
                  ...
                  <a class="item" href="{{route('sosadmin.user.editPolice',['id'=>$item->SO_TAI_KHOAN])}}" data-toggle="tooltip" data-placement="top" title="Sửa">
                     <i class="zmdi zmdi-edit"></i>
                     </a>
                     <a class="item" href="" data-toggle="tooltip" data-placement="top" title="Sửa">
